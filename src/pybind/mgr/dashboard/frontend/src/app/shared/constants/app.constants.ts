...
export class AppConstants {
  public static readonly organization = 'zstore';
  public static readonly projectName = 'Zstore Dashboard';
  public static readonly license = 'Free software (LGPL 2.1).';
  public static readonly copyright = 'Copyright(c) ' + environment.year + ' Zstore contributors.';
  public static readonly cephLogo = 'assets/zstore-pref.svg';
}
