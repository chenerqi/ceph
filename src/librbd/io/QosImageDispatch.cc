...
bool QosImageDispatch<I>::read(
  ...
  if (m_qos_exclude_ops & IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_READ) {
    return false;
  }
...
bool QosImageDispatch<I>::write(
  ...
  if (m_qos_exclude_ops & IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_WRITE) {
    return false;
  }
...
bool QosImageDispatch<I>::discard(
  ...
  if (m_qos_exclude_ops & IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_DISCARD) {
    return false;
  }
...
bool QosImageDispatch<I>::write_same(
  ...
  if (m_qos_exclude_ops & IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_WRITE_SAME) {
    return false;
  }
...
bool QosImageDispatch<I>::compare_and_write(
  ...
  if (m_qos_exclude_ops & IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_COMPARE_AND_WRITE) {
    return false;
  }
