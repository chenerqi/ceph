...
enum {
  IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_READ              = 1 << 0,
  IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_WRITE             = 1 << 1,
  IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_DISCARD           = 1 << 2,
  IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_WRITE_SAME        = 1 << 3,
  IMAGE_DISPATCH_FLAG_QOS_EXCLUDE_COMPARE_AND_WRITE = 1 << 4
};
